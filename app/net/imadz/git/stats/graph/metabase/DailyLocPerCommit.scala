...
class DailyLocPerCommit(override val ws: WSClient, override val domain: String) extends CardGenerator with DatabaseMetadataProducer {
  ...
  override def graphName(project: String, branch: String): String = s"${shortName(project)}/$branch Daily Loc Per Commit"
}
